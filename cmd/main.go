...
import (
	...
	"github.com/openclaw/operator/internal/controller"
...
func main() {
	...
	mgr, err := ctrl.NewManager(ctrl.GetConfigOrDie(), ctrl.Options{
		...
		LeaderElectionID:       "openclaw-operator.openclaw.platform",
	})
	if err != nil {
	...
	if err = (&controller.OpenClawInstanceReconciler{
		...
		Recorder: mgr.GetEventRecorderFor("openclaw-operator"),
